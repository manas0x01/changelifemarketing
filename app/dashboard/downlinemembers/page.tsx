...
const sampleData: Member[] = [
  { srNo: 1, memberId: "SM112233", name: "Rahul Sharma",  sponsorId: "Sm674643", placementId: "Sm674643", joiningDate: "10-Jan-2026", position: "Left"  },
  { srNo: 2, memberId: "SM445566", name: "Priya Singh",   sponsorId: "Sm674643", placementId: "SM112233", joiningDate: "23-Oct-2025", position: "Right" },
  { srNo: 3, memberId: "SM778899", name: "Amit Verma",    sponsorId: "SM112233", placementId: "SM112233", joiningDate: "01-Oct-2025", position: "Left"  },
  { srNo: 4, memberId: "SM334455", name: "Sunita Devi",   sponsorId: "Sm674643", placementId: "SM445566", joiningDate: "20-Sep-2025", position: "Right" },
  { srNo: 5, memberId: "SM667788", name: "Vijay Kumar",   sponsorId: "SM445566", placementId: "SM445566", joiningDate: "18-Sep-2025", position: "Left"  },
  { srNo: 6, memberId: "SM990011", name: "Neha Gupta",    sponsorId: "SM112233", placementId: "SM778899", joiningDate: "05-Aug-2025", position: "Right" },
  { srNo: 7, memberId: "SM223344", name: "Manoj Yadav",   sponsorId: "SM334455", placementId: "SM334455", joiningDate: "12-Jul-2025", position: "Left"  },
  { srNo: 8, memberId: "SM556677", name: "Kavita Mishra", sponsorId: "SM667788", placementId: "SM667788", joiningDate: "30-Jun-2025", position: "Right" },
];
...
export default function DownlineMembersPage() {
  ...
  const handleExportCSV = () => {
    ...
    const a    = document.createElement("a"); a.href = url; a.download = "downline-members.csv"; a.click();
                    ...
                    <tr>
                      <td colSpan={6}>
                        <div className="empty-state">
                          ...
                          <p>{hasFiltered ? "No downline members found for the selected filters." : "Please use the filter above to view downline members."}</p>
                        </div>
                      </td>
                    </tr>
                  )}
