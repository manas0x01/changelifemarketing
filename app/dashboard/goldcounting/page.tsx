...
const sampleData: ReportRow[] = [
  { srNo: 1, rbv: 500,  lbv: 500,  rCarry: 0,   lCarry: 0,   matching: 1, date: "10-Jan-2026", fromMemberId: "SM138501", product: "Agriculture Package",  description: "Gold Counting"  },
  { srNo: 2, rbv: 1000, lbv: 500,  rCarry: 500,  lCarry: 0,   matching: 1, date: "23-Oct-2025", fromMemberId: "SM649260", product: "Healthcare Package",   description: "Gold Counting"  },
  { srNo: 3, rbv: 500,  lbv: 1000, rCarry: 0,   lCarry: 500,  matching: 1, date: "01-Oct-2025", fromMemberId: "SM491066", product: "Sanitary Napkine",     description: "Gold Counting"  },
  { srNo: 4, rbv: 1500, lbv: 1000, rCarry: 500,  lCarry: 0,   matching: 2, date: "20-Sep-2025", fromMemberId: "SM873277", product: "Agriculture Package",  description: "Gold Counting"  },
  { srNo: 5, rbv: 500,  lbv: 500,  rCarry: 0,   lCarry: 0,   matching: 1, date: "18-Sep-2025", fromMemberId: "SM408648", product: "Healthcare Package",   description: "Gold Counting"  },
  { srNo: 6, rbv: 2000, lbv: 1500, rCarry: 500,  lCarry: 0,   matching: 3, date: "05-Aug-2025", fromMemberId: "SM943014", product: "Agriculture Package",  description: "Gold Counting"  },
];

export default function GoldCountingReportPage() {
  ...
  const handleExportCSV = () => {
    ...
    const a    = document.createElement("a"); a.href = url; a.download = "gold-counting-report.csv"; a.click();
    ...
    <>
      ...
      <div className="gc-root">
        ...
        <div className="breadcrumb">
          ...
          <a href="#">Reports</a>
          <span className="sep">/</span>
          <span>Gold Counting Report</span>
        </div>
        ...
        <div className="page-body">
          <div className="main-card">
            ...
            <div className="section-header">
              <span className="section-title">Gold Counting Detail</span>
                    ...
                    <tr>
                      <td colSpan={10}>
                        <div className="empty-state">
                          ...
                          <p>{hasFiltered ? "No gold counting records found." : "Please use the filter above to view gold counting report."}</p>
                        </div>
                      </td>
                    </tr>
                  )}
