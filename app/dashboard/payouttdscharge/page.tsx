...
const allData: TDSRow[] = [
  { srNo: 1,  payoutDate: "21 Sep 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 2,  payoutDate: "30 Oct 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 3,  payoutDate: "05 Nov 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 4,  payoutDate: "10 Nov 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 5,  payoutDate: "13 Nov 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 6,  payoutDate: "20 Nov 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 7,  payoutDate: "22 Dec 2024 12:00:00", total: 1500, tds: 30 },
  { srNo: 8,  payoutDate: "28 Dec 2024 12:00:00", total: 1500, tds: 75 },
  { srNo: 9,  payoutDate: "05 Jan 2025 12:00:00", total: 1500, tds: 75 },
  { srNo: 10, payoutDate: "12 Jan 2025 12:00:00", total: 1500, tds: 75 },
  { srNo: 11, payoutDate: "20 Jan 2025 12:00:00", total: 1500, tds: 75 },
  { srNo: 12, payoutDate: "28 Jan 2025 12:00:00", total: 1500, tds: 75 },
  { srNo: 13, payoutDate: "04 Feb 2025 12:00:00", total: 1500, tds: 75 },
  { srNo: 14, payoutDate: "12 Feb 2025 12:00:00", total: 1500, tds: 75 },
  { srNo: 15, payoutDate: "20 Feb 2025 12:00:00", total: 1500, tds: 30 },
];

export default function PayoutTDSChargePage() {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const [cycle,        setCycle]        = useState("--All--");
  const [data,         setData]         = useState<TDSRow[]>(allData);
  ...
  const handleExportCSV = () => {
    const header = "Sr.No.,Payout Date,Total,TDS";
    const rows   = data.map(r => `${r.srNo},"${r.payoutDate}",${r.total},${r.tds}`).join("\n");
    const blob   = new Blob([header + "\n" + rows], { type: "text/csv" });
    const url    = URL.createObjectURL(blob);
    const a      = document.createElement("a"); a.href = url; a.download = "payout-tds-charge.csv"; a.click();
    ...
    <>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .tds-root { font-family:'Poppins',sans-serif; background:#f0f2f5; min-height:100vh; }
        ...
        .data-table tbody tr:hover { background:#fef3f3; transition:background .15s; }
        .data-table tbody td {
          padding:16px 20px; color:#333; font-size:13px;
        }

        /* Numeric cells */
        .num-total { font-weight:600; color:#1976d2; }
        .num-tds   { font-weight:700; color:#e53935; font-size:13.5px; }

        /* Total row */
        .total-row td {
          background:#fef3f3 !important;
          font-weight:700; border-top:2px solid #e53935; color:#b71c1c;
          padding:13px 20px;
        }
        ...
        .footer-total { font-weight:700; color:#e53935; font-size:13px; }
      `}</style>

      <div className="tds-root" onClick={() => dropdownOpen && setDropdownOpen(false)}>
        ...
        <div className="page-body">
          <div className="main-card">
            ...
            <div className="section-header">
              <span className="section-title">Payout TDS Charge</span>
            ...
            {/* TOTAL TDS */}
            <div className="total-tds">
              Total TDS Charge : <span>{totalTDS}</span>
            </div>
              ...
              <table className="data-table">
                ...
                <tbody>
                  ...
                  <tr className="total-row">
                    ...
                    <td><span className="num-tds">{totalTDS}</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="table-footer">
              ...
              <span className="footer-total">Total TDS Charge: {totalTDS}</span>
            </div>
