    ...
    <>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .total-netpay span { color:#FFD700; text-shadow: 0 0 8px rgba(255,215,0,0.3); font-size: 17px; }
              ...
              <table className="data-table">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={10} style={{ textAlign: "center", padding: "45px", color: "rgba(255,215,0,0.5)" }}>
