...
const stateDistrictMap: Record<string, string[]> = {
  "Andhra Pradesh": ["Alluri Sitharama Raju","Anakapalli","Anantapur","Annamayya","Bapatla","Chittoor","East Godavari","Eluru","Guntur","Kakinada","Konaseema","Krishna","Kurnool","Manyam","NTR","Nandyal","Nellore","Palnadu","Prakasam","Sri Potti Sriramulu Nellore","Srikakulam","Tirupati","Visakhapatnam","Vizianagaram","West Godavari","YSR Kadapa"],
  ...
  "Punjab": ["Amritsar","Barnala","Bathinda","Faridkot","Fatehgarh Sahib","Fazilka","Ferozepur","Gurdaspur","Hoshiarpur","Jalandhar","Kapurthala","Ludhiana","Malerkotla","Mansa","Moga","Mohali","Muktsar","Nawanshahr","Pathankot","Patiala","Ropar","Sangrur","Tarn Taran"],
...
const indianStates = Object.keys(stateDistrictMap);
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .placement-item {
          font-size: 13.5px;
          color: rgba(255,233,124,0.8);
          font-weight: 400;
        }
        .placement-item strong { color: #ffe97c; font-weight: 700; }
        ...
        .update-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 18px rgba(255,233,124,0.35); }
        ...
        .toast {
          ...
          font-size: 13.5px;
          font-weight: 700;
          box-shadow: 0 6px 22px rgba(255,233,124,0.4);
          z-index: 999;
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          const firstDistrict = (stateDistrictMap[newState] || [])[0] || "";
                          setFormData(prev => ({ ...prev, state: newState, district: firstDistrict }));
                        }}
                      >
