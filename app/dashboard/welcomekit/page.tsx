            ...
            <div ref={certRef} className="cert-wrap">
              ...
              <div className="cert-content">
                ...
                <div className="cert-logo">
                  <img src="/images/logocertificate.png" alt="Change Life Marketing" style={{ maxWidth: '140px', height: 'auto' }} suppressHydrationWarning />
                </div>
            ...
            <div ref={idRef} className="id-card-wrap">
              ...
              <div className="id-top-section">
                ...
                <div className="id-logo">
                  <img src="/images/logocertificate.png" alt="Change Life Marketing" style={{ maxWidth: '120px', height: 'auto' }} suppressHydrationWarning />
                </div>
            ...
            <div ref={visitRef} className="visit-card-wrap">
              ...
              <div className="visit-top">
                <div className="visit-logo">
                  <img src="/images/logocertificate.png" alt="Change Life Marketing" style={{ maxWidth: '110px', height: 'auto' }} suppressHydrationWarning />
                </div>
              </div>
