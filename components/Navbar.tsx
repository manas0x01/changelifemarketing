    ...
    <>
      <style>{`
        ...
        .topnav {
          ...
          top: 0;
          z-index: 100;
          border-bottom: 1px solid rgba(255,233,124,0.25);
          box-shadow: 0 10px 30px rgba(0,0,0,0.55), 0 1px 0 rgba(255,233,124,0.15), inset 0 1px 0 rgba(255,255,255,0.05);
        ...
        .topnav::after {
          ...
          box-shadow: 0 0 12px rgba(255,233,124,0.8);
        }
        ...
        .hamburger-btn:hover {
          ...
          border-color: rgba(255,233,124,0.6);
          transform: scale(1.05);
          box-shadow: 0 0 12px rgba(255,233,124,0.35);
        }
        .hamburger-btn span {
          display: block;
          height: 2px;
        ...
        .nav-bell:hover { background: rgba(255,233,124,0.15); }
        .nav-bell-badge {
          position: absolute;
          top: -3px; right: -3px;
          width: 16px; height: 16px;
          background: linear-gradient(135deg, #ffe97c, #ffe97c);
          border-radius: 50%;
          font-size: 9px;
          font-weight: 800;
          color: #120228;
          ...
          box-shadow: 0 0 10px rgba(255,233,124,0.6);
          animation: bellpulse 2s infinite alternate;
        }
        @keyframes bellpulse {
          0% { transform: scale(1); box-shadow: 0 0 4px rgba(255,233,124,0.5); }
          100% { transform: scale(1.12); box-shadow: 0 0 12px rgba(255,233,124,0.9); }
        }
        ...
        .user-chip {
          ...
          align-items: center;
          gap: 8px;
          background: rgba(255,233,124,0.07);
          border: 1px solid rgba(255,233,124,0.18);
          border-radius: 24px;
        ...
        .user-chip:hover {
          ...
          border-color: rgba(255,233,124,0.6);
          box-shadow: 0 0 15px rgba(255,233,124,0.25);
        }
        ...
        .user-avatar-ring {
          ...
          padding: 1.5px;
          flex-shrink: 0;
          box-shadow: 0 0 8px rgba(255,233,124,0.3);
        }
        .user-avatar {
        ...
        .user-name-text {
          ...
          text-shadow: 0 0 6px rgba(255,233,124,0.25);
        }
        .user-name-text span {
          color: #ffe97c;
          font-weight: 800;
        ...
        .skeleton-loader {
          ...
          background: linear-gradient(90deg,
            rgba(255,233,124,0.08) 25%,
            rgba(255,233,124,0.15) 50%,
            rgba(255,233,124,0.08) 75%);
        ...
        .dropdown {
          ...
          border: 1px solid rgba(255,233,124,0.4);
          border-radius: 16px;
          width: 220px;
          box-shadow:
            0 16px 48px rgba(0,0,0,0.7),
            0 0 25px rgba(255,233,124,0.25);
          z-index: 200;
          overflow: hidden;
        ...
        .dropdown-header {
          ...
          background: rgba(255,233,124,0.05);
        }
        .dropdown-welcome {
          font-size: 10px;
          font-weight: 700;
        ...
        .dropdown-item:hover {
          background: rgba(255,233,124,0.12);
          color: #ffe97c;
          box-shadow: inset 0 0 8px rgba(255,233,124,0.15);
        }
        ...
        .dropdown-divider {
          height: 1px;
          background: linear-gradient(90deg, transparent, rgba(255,233,124,0.15), transparent);
          margin: 2px 0;
        }
      `}</style>
      ...
      <nav className="topnav">
        ...
        <div className="topnav-right">
          ...
          <div className="nav-bell">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffe97c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
